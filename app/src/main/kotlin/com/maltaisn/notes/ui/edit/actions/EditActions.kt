...
data class EditActionsAvailability(
    ...
    val zoomIn: EditActionAvailability = EditActionAvailability.HIDDEN,
    val zoomOut: EditActionAvailability = EditActionAvailability.HIDDEN,
    ...
    fun createActions(context: Context): List<EditAction> {
        return listOf(
            ...
            EditAction(redo,
                ...
                EditViewModel::redo),
            EditAction(zoomIn,
                R.string.action_increase_text_size,
                R.drawable.ic_plus,
                false,
                EditViewModel::zoomIn),
            EditAction(zoomOut,
                R.string.action_decrease_text_size,
                R.drawable.ic_minus,
                false,
                EditViewModel::zoomOut),
